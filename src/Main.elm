...
view model =
    ...
    case model of
        ...
        Agents agents ->
            viewPage Page.Agents GotAgentsMsg (Agents.view agents)
...
changeRouteTo maybeRoute model =
    ...
    case maybeRoute of
        ...
        Just Route.Agents ->
            Agents.init session
                |> updateWith Agents GotAgentsMsg model
...
update msg model =
    case ( msg, model ) of
        ...
        ( GotAgentsMsg subMsg, Agents agents ) ->
            Agents.update subMsg agents
                |> updateWith Agents GotAgentsMsg model
...
subscriptions model =
    case model of
        ...
        Agents agents ->
            Sub.map GotAgentsMsg (Agents.subscriptions agents)
