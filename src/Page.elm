...
viewMenu page maybeViewer =
    ...
    case maybeViewer of
        ...
        Nothing ->
            [ linkTo Route.Agents [ text "Agents" ]
...
viewFooter =
    footer []
        [ div [ class "container" ]
            [ a [ class "logo-font", href "/" ] [ text "stignore-manager" ]
            , span [ class "attribution" ]
                [ text "Original code from "
                , a [ href "https://github.com/rtfeldman/elm-spa-example" ] [ text "elm-spa-example" ]
                ]
            ]
        ]
